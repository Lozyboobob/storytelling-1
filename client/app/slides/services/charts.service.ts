...
import {
  ...
  BubbleChartComponent, SunburstChartComponent, WordCloudComponent,AreaChartComponent
} from 'app/charts';
...
export class ChartsService {
  ...
  constructor(private _resolver: ComponentFactoryResolver) {
    ...
    this.listWidget = new Map<string, Type<any>>([['PieChartComponent', PieChartComponent],
      ...
      ['SunburstChartComponent', SunburstChartComponent],['AreaChartComponent', AreaChartComponent],['WordCloudComponent', WordCloudComponent]
    ]);
  }
