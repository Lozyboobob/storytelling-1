...
export class ScrollDirective implements OnInit {
    ...
    private delayDuration: number = 25;
    ...
    ngOnInit() {
        let events = Observable.fromEvent(window, 'scroll', (e) => e);
        ...
        pageChangeObservable.subscribe(e => this.mouseScroll.emit());
    }
    ...
    @HostListener('onmousewheel', ['$event']) private onMouseWheelIE(event: any) { this.mouseWheelFunc(event); } private mouseWheelFunc(event: any) {
