...
const lineChartExample = '{"graphData":[[{"yAxis" : "1394.46","xAxis" : "Jan 2000",  "series" : "S&P 500"}, ' +
    '{"yAxis" : "1366.42",  "xAxis" : "Feb 2000","series" : "S&P 500"}, ' +
    '{  "yAxis" : "1498.58","xAxis" : "Mar 2000",  "series" : "S&P 500"}],[{"yAxis" : "1285.36","xAxis" : "Jan 2000",  "series" : "IBM"}, {"yAxis" : "1299.98",  "xAxis" : "Feb 2000","series" : "IBM"}, {  "yAxis" : "1322.20","xAxis" : "Mar 2000",  "series" : "IBM"}]]}';
const pieChartExample ='{ "graphData": [{"label" : "data1", "value": 1}, {"label" : "data2", "value" : 2}, {"label" : "data3","value" : 3}, { "label" : "data4", "value" : 4}]}';

const HierarchicalEdgeExample ='{"graphData": [{"name":"flare.analytics.cluster.AgglomerativeCluster","size":3938,"imports":["flare.animate.Transitioner","flare.vis.data.DataList","flare.util.math.IMatrix","flare.analytics.cluster.MergeEdge","flare.analytics.cluster.HierarchicalCluster","flare.vis.data.Data"]},' +
