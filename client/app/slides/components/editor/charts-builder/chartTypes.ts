...
import { PieChartComponent, AdvancedPieChartComponent, BarChartComponent, ForceDirectedGraphComponent, GaugeChartComponent,HierarchicalEdgeBundlingComponent, PieGridChartComponent, LineChartComponent, DendogramComponent, NgGraphComponent, TreemapChartComponent
...
export const chartTypes = [
    ...
    createChartType({ title: 'Line Chart D3', simpleData: true, cmpName: 'LineChart', convertData: LineChartComponent.convertData, dimLabels: ['Group By', 'X-Value', 'Y-Value', null] }),
