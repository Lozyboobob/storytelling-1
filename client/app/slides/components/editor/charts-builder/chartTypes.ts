...
export const chartTypes = [
    ...
    createChartType({
        title: 'Pie Chart', simpleData: true, cmpName: 'pieChart', convertData: PieChartComponent.convertData, dimLabels: [{ column: 'Name', maxSize: 1 }, { column: 'Value', maxSize: 1 }],
    ...
    createChartType({
        title: 'Word Cloud Chart', simpleData: true, cmpName: 'wordCloud', convertData: WordCloudComponent.convertData, dimLabels: [{ column: 'Name', maxSize: 1 }, { column: 'Value', maxSize: 1 }],
    ...
    createChartType({
        title: 'Zoomable Treemap', simpleData: true, cmpName: 'zoomableTreemapChart', convertData: ZoomableTreemapChartComponent.convertData, dimLabels: [{ column: 'Hierarchy', maxSize: 10 }, { column: 'Value', maxSize: 1 },],
    ...
    createChartType({
        title: 'Sunburst', simpleData: true, cmpName: 'sunburstChart', convertData: SunburstChartComponent.convertData, dimLabels: [{ column: 'Hierarchy', maxSize: 10 }, { column: 'Value', maxSize: 1 },],
    ...
    createChartType({
        title: 'Pie Grid Chart', simpleData: true, cmpName: 'pieGridChart', convertData: PieGridChartComponent.convertData, dimLabels: [{ column: 'Name', maxSize: 1 }, { column: 'Value', maxSize: 1 }],
        description: '',
        categorie: 'Comparison',
        image: 'assets/img-graph/pieGridChart.jpg'
    }),
    createChartType({
        title: 'Force Layout Bubble', simpleData: true, cmpName: 'bubbleChart', convertData: BubbleChartComponent.convertData, dimLabels: [{ column: 'category', maxSize: 1 }, { column: 'Label', maxSize: 1 }, { column: 'Value', maxSize: 1 }, { column: 'Description', maxSize: 1 }],
        description: '',
    ...
    createChartType({
        title: 'Polar Chart', convertData: NgGraphComponent.convertData, dimLabels: [{ column: 'Group by', maxSize: 1 }, { column: 'Angle Values', maxSize: 1 }, { column: 'Radius Values', maxSize: 1 }],
        description: '',
        categorie: 'Comparison',
        image: 'assets/img-graph/polarChart.jpg'
    }),
    createChartType({
        title: 'Line Chart', convertData: NgGraphComponent.convertData, dimLabels: [{ column: 'GroupBy', maxSize: 1 }, { column: 'x-Values', maxSize: 1 }, { column: 'y-Values', maxSize: 1 }],
    ...
    createChartType({
        title: 'Heat Map', convertData: NgGraphComponent.convertData, dimLabels: [{ column: 'x-Category', maxSize: 1 }, { column: 'y-Category', maxSize: 1 }, { column: 'Color', maxSize: 1 }],
        description: '',
        categorie: 'Comparison',
        image: 'assets/img-graph/heatMap.jpg'
    }),
    createChartType({
        title: 'Bubble Chart', convertData: NgGraphComponent.convertData, dimLabels: [{ column: 'GroupBy', maxSize: 1 }, { column: 'x-Values', maxSize: 1 }, { column: 'y-Values', maxSize: 1 }, { column: 'Radius', maxSize: 1 }],
        description: '',
        categorie: 'Dispersion',
        image: 'assets/img-graph/bubbleChart.jpg'
    }),
    createChartType({
        title: 'Treemap', simpleData: true, cmpName: 'treemapChart', convertData: TreemapChartComponent.convertData, dimLabels: [{ column: 'Group by', maxSize: 10 }, { column: 'Value', maxSize: 1 }],
    ...
    createChartType({
        title: 'Advanced Pie Chart', simpleData: true, cmpName: 'AdvancedPieChart', convertData: AdvancedPieChartComponent.convertData, dimLabels: [{ column: 'Group by', maxSize: 1 }, { column: 'Value', maxSize: 1 }],
    ...
    createChartType({
        title: 'Gauge Chart', simpleData: true, cmpName: 'GaugeChart', convertData: GaugeChartComponent.convertData, dimLabels: [{ column: 'Group by', maxSize: 1 }, { column: 'Value', maxSize: 1 }],
    ...
    createChartType({
        title: 'Area Chart', simpleData: true, cmpName: 'areaChart', convertData: AreaChartComponent.convertData, dimLabels: [{ column: 'Group by', maxSize: 1 }, { column: 'x-Values', maxSize: 1 }, { column: 'y-Values', maxSize: 1 }],
