...
export const chartTypes = [
  ...
  createChartType({ title: 'Number Cards', simpleData: true, cmpName: 'numberCard', convertData: NumberCardComponent.convertData, dimLabels: [ {column: 'Card Name', maxSize: 1} , {column: 'Card Value', maxSize: 1} ],
      description : '',
  ...
  createChartType({ title: 'Zoomable Treemap', simpleData: true, cmpName: 'zoomableTreemapChart', convertData: ZoomableTreemapChartComponent.convertData, dimLabels: [ {column: 'Hierarchy', maxSize: 10} , {column: 'Value', maxSize: 1}, ],
